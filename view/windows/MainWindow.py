...
class UIMainWindow(object):
    def setup_ui(self, shell_view):
        ...
        self.remove_rule_button = QtWidgets.QPushButton(self.edit_rules_gb)
        self.remove_rule_button.setGeometry(QtCore.QRect(5, 65, 180, 25))
        ...
        self.remove_var_button = QtWidgets.QPushButton(self.edit_var_gb)
        self.remove_var_button.setGeometry(QtCore.QRect(5, 65, 180, 25))
        ...
        self.remove_domain_button = QtWidgets.QPushButton(self.edit_domain_gb)
        self.remove_domain_button.setGeometry(QtCore.QRect(5, 65, 180, 25))
